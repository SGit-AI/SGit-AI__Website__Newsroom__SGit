<!-- Generated from business-case-unleash.html by scripts/site/generate.mjs. Edit the page, not this file. -->

# RiskMandate — the business case for Unleash

Unleash (Unleash (company-maintained)), by the risk it changes: the register for a stated agent deployment without it and with it, computed from a public model, from the operator to the board.

Source: https://riskmandate.ai/business-case-unleash.html
...
**Open source:** AGPL-3.0 (server); Apache-2.0 (Node SDK) · Unleash (company-maintained) · [get involved](https://slack.unleash.run)
...
- A kill-switch flag type, to disable part of a system gracefully. “Kill switch Gracefully degrade system functionality.” · [docs.getunleash.io](https://docs.getunleash.io/concepts/feature-flags), read 24 September 2026
