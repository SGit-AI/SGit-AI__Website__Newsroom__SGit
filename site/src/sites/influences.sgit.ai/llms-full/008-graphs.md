...
*Source: <https://influences.sgit.ai/register/graphs/index.html> · markdown twin of the entry page.*
...
The founding obsession, and the one link-out entry that owns something its sibling site does not: the personal history. Where graphs actually entered the thinking is an open question, and it is asked in public.

## Block 1 — The anchor

The first encounter — likely the O2 Platform's code-flow work

**Unconfirmed.** Unlike every other entry, this anchor is a personal event rather than a published work, and the pack could not establish which one. Asked as [Q5](../../admin/comms.html#q5) in the briefing queue.
...
**Structure is edges. What a thing is matters less than what it connects to, and a model that records connection can answer questions its designer did not anticipate.**

## Block 4 — The trace table

**Where the trace table would be:** **The trace of this influence is an entire site**, and a much larger one than this entry could hold. What this entry owns and the sibling does not carry is the *personal* history: where the interest came from, and when. That part is [an open question](../../admin/comms.html#q5) rather than a claim.
...
|---|---|
| `(corpus-wide)` | too pervasive to count usefully — the mining run found graph thinking in the substrate, the concept documents, the guides and the role definitions |
| `graphs.sgit.ai (sibling site)` | the grammar, the depth model and the book — the material this entry deliberately does not repeat |
...
==============================================================================
source: /register/owasp/index.md
