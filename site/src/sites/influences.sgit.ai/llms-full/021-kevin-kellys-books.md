...
*What Technology Wants* (2010), *The Inevitable* (2016), or *1,000 True Fans* (2008) — Kevin Kelly

**Three candidates, none confirmed.** They are quite different books and the entry reads differently depending which one did the shaping — [N2](../../admin/comms.html#n2).
...
- **What Technology Wants (2010)** — the technium argument in full
- **The Inevitable (2016)** — twelve forces, framed as things already in motion
- **1,000 True Fans (2008)** — the essay, published free — a different argument entirely, about who has to like your work <https://kk.org/thetechnium/1000-true-fans/>
- **Out of Control (1994)** — the earliest and strangest of them; decentralised systems before it was a genre
...
==============================================================================
source: /register/sinek-golden-circle/index.md
