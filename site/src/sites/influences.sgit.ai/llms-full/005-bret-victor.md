...
The model entry, and the reason this site has a format at all. The register for *Inventing on Principle* was written as a working document before anyone asked what a site made of such documents should be called.

## Block 1 — The anchor

Inventing on Principle — Bret Victor — CUSEC · 2012
- anchor: <https://vimeo.com/36579366>
- transcript: <https://worrydream.com/>

One anchor per entry: not the whole career, the single work that did the shaping. Victor's wider work is in Block 7.
...
> the problem with dogma is not that it exists, but that you stop asking the question.
>
> — Dinis Cruz, `briefs/.../v0.19.7__article__education-gaps-git-opensource.md`
...
**Immediate connection between creator and creation — a creator needs to see what they are making, as they make it.**

The test the format sets for a principle is that it must be usable by someone who has never consumed the anchor work. This one passes: you can apply it to a build pipeline, a form, a CLI or a lesson plan without having watched the talk.
...
The register names this as a specified gap: the viewer cannot step backwards through the states a view has been in. Victor's demos treat time as a dimension you can scrub, not a sequence you can only move forward through — the binary-search-for-the-bug case in the talk is the canonical demonstration. Precise scope is in the register text this site does not yet hold.

### G2 — Relayout ghosts

The register's second named gap: when a layout changes, the previous positions leave no trace, so a person cannot see what moved. Victor's argument is that a change you cannot see the shape of is a change you cannot reason about. Precise scope is in the register text this site does not yet hold.
...
- **The Future of Programming** — the 1973 costume talk — a history of ideas that were abandoned rather than disproved <https://worrydream.com/dbx/>
- **Media for Thinking the Unthinkable** — why the representations we use bound the thoughts we can have <https://worrydream.com/MediaForThinkingTheUnthinkable/>
- **Up and Down the Ladder of Abstraction** — the interactive essay about moving between the concrete and the general — arguably the most directly applicable to graph work <https://worrydream.com/LadderOfAbstraction/>
- **Stop Drawing Dead Fish** — on tools that produce artefacts versus tools that produce behaviour <https://worrydream.com/StopDrawingDeadFish/>
- **Drawing Dynamic Visualizations** — direct manipulation applied to data visualisation itself <https://worrydream.com/DrawingDynamicVisualizationsTalk/>
- **The Humane Representation of Thought** — the widest version of the argument: thinking with the whole body, not a rectangle <https://worrydream.com/TheHumaneRepresentationOfThought/>
- **Dynamicland** — the research programme the ideas went into <https://dynamicland.org/>
...
==============================================================================
source: /register/wardley/index.md
