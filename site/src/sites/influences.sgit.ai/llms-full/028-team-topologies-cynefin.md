...
**Organisational structure and problem-domain sensemaking are engineering concerns: the shape of the team decides the shape of the system, and the kind of problem decides which practice is appropriate.**

## Block 7 — The wider library

- **Team Topologies — Skelton & Pais (2019)** — four team types and three interaction modes <https://teamtopologies.com/>
- **Cynefin — Dave Snowden** — the sensemaking framework; the clear/complicated/complex/chaotic distinction is the transferable part <https://thecynefin.co/>
- **A Leader's Framework for Decision Making (HBR, 2007)** — Snowden and Boone's most-read statement of it <https://hbr.org/2007/11/a-leaders-framework-for-decision-making>
...
|---|---|
| `(a 2019 hiring post)` | both frameworks listed beside Wardley mapping; the only occurrence the mining run found |
...
==============================================================================
source: /register/vannevar-bush/index.md
