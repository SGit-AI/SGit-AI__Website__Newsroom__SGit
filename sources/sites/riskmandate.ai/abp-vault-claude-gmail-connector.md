<!-- Generated from abp-vault-claude-gmail-connector.html by scripts/site/generate.mjs. Edit the page, not this file. -->

# RiskMandate — the behaviour-policy vault for Claude's Gmail connector

The template Agent Behaviour Policy vault for Claude's Gmail connector (anthropic/gmail-connector/default), rendered live from vault oc433z3m: the card, the mandate, the grant with a barrier per row, the delta, the Licence to Operate, the vault’s own app in a sandboxed frame, the file list and the public read key.

Source: https://riskmandate.ai/abp-vault-claude-gmail-connector.html
...
The read key travels to the host over a same-page handshake, never in a URL. Nothing you do in either frame touches the vault: it is opened read-only, and the write key is not published. Not loading? [Open it in its own tab ↗](https://dev.vault.sgraph.ai/en-gb/#22fd71dfcc045d047846972e051fd97444f75e0c53da3fde9a233060023cee04:oc433z3m).
