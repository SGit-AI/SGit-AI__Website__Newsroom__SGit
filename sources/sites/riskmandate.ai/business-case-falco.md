<!-- Generated from business-case-falco.html by scripts/site/generate.mjs. Edit the page, not this file. -->

# RiskMandate — the business case for Falco

Falco (CNCF (graduated)), by the risk it changes: the register for a stated agent deployment without it and with it, computed from a public model, from the operator to the board.

Source: https://riskmandate.ai/business-case-falco.html
...
**Open source:** Apache-2.0 · CNCF (graduated) · [get involved](https://falco.org/community/)
...
- Real-time alerts on kernel and plugin events, by rule. “Falco is a monitoring and detection agent that observes events (such as Linux kernel events and other data sources through plugins ) and delivers real-time alerts based on custom rules.” · [falco.org](https://falco.org/docs/), read 24 September 2026
...
- Write rules for what the agent's processes should and should not do.
- Send alerts somewhere a person reads them.
...
- **real time.** Real-time alerts on the documentation home page, and a troubleshooting page on busy servers where Falco may be dropping events. [docs](https://falco.org/docs/) · [dropping](https://falco.org/docs/troubleshooting/dropping/)
