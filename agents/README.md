...
|---|---|---|---|---|---|
| [**Librarian**](librarian.desk/ROLE.md) | `@Librarian` | desk | first, every day | `sources/`, `data/changes/`, `data/index.json`, `data/concepts.json`, `data/vaults.json` | [ROLE](librarian.desk/ROLE.md) · [MANDATE](librarian.desk/MANDATE.md) |
...
| [**Architect**](architect.guest/ROLE.md) | `@Architect` | guest desk | when the day's changes give it something to say | `signals/` | [ROLE](architect.guest/ROLE.md) · [MANDATE](architect.guest/MANDATE.md) |
| [**Developer**](developer.guest/ROLE.md) | `@Developer` | guest desk | when the day's changes give it something to say | `signals/` | [ROLE](developer.guest/ROLE.md) · [MANDATE](developer.guest/MANDATE.md) |
| [**Cartographer**](cartographer.guest/ROLE.md) | `@Cartographer` | guest desk | when the day's changes give it something to say | `signals/` | [ROLE](cartographer.guest/ROLE.md) · [MANDATE](cartographer.guest/MANDATE.md) |
| [**Build desk**](build.desk/ROLE.md) | `@Build` | construction | when the site, the tools or the pipeline change | `tools/`, `.github/`, `.claude/`, `agents/`, `run-local.sh`, `README.md`, `AUTHORING.md`, `CLAUDE.md` | [ROLE](build.desk/ROLE.md) · [MANDATE](build.desk/MANDATE.md) |
| [**Editor of record**](editor.human/ROLE.md) | `@Editor` | human | before anything is called published | `editions/`, `stories/`, `history/`, `signals/`, `data/agents.json` | [ROLE](editor.human/ROLE.md) · [MANDATE](editor.human/MANDATE.md) |
