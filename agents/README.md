...
| [**Editor of record**](editor.human/ROLE.md) | `@EditorOfRecord` | human | before anything is called published | `editions/`, `stories/`, `history/`, `signals/`, `maps/`, `data/agents.json`, `admin/` | [ROLE](editor.human/ROLE.md) · [MANDATE](editor.human/MANDATE.md) |
